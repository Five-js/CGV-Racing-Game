...
export class Tumi {
  ...
  drawCross(loader, y, scene) {
    ...
    loader.load(
      ...
      function (gltf) {
        let mesh = gltf.scene;
        mesh.position.set(5, y - 10, 213.5);
    ...
    loader.load(
      ...
      function (gltf) {
        let mesh = gltf.scene;
        mesh.position.set(1083.8, y - 10, 213.5);
        mesh.scale.set(4, 1, 4.5);
        // mesh.rotation.set(0, Math.PI/2, 0);
        scene.add(mesh);
      },
    ...
    loader.load(
      ...
      function (gltf) {
        let mesh = gltf.scene;
        mesh.position.set(1083.8, y - 10, -97.3);
        mesh.scale.set(4, 1, 4.5);
        // mesh.rotation.set(0, Math.PI/2, 0);
        scene.add(mesh);
      },
    ...
    loader.load(
      ...
      function (gltf) {
        let mesh = gltf.scene;
        mesh.position.set(355.1, y - 10, -97.3);
        mesh.scale.set(4, 1, 4.5);
        // mesh.rotation.set(0, Math.PI/2, 0);
        scene.add(mesh);
      },
    ...
    loader.load(
      ...
      function (gltf) {
        let mesh = gltf.scene;
        mesh.position.set(355.1, y - 10, -337.3);
        mesh.scale.set(4, 1, 4.5);
        // mesh.rotation.set(0, Math.PI/2, 0);
        scene.add(mesh);
      },
    ...
    loader.load(
      ...
      function (gltf) {
        let mesh = gltf.scene;
        mesh.position.set(733.7, y - 10, -337.3);
        mesh.scale.set(4, 1, 4.5);
        // mesh.rotation.set(0, Math.PI/2, 0);
        scene.add(mesh);
      },
    ...
    loader.load(
      ...
      function (gltf) {
        let mesh = gltf.scene;
        mesh.position.set(733.7, y - 10, -577.3);
        mesh.scale.set(4, 1, 4.5);
        // mesh.rotation.set(0, Math.PI/2, 0);
        scene.add(mesh);
      },
    ...
    loader.load(
      ...
      function (gltf) {
        let mesh = gltf.scene;
        mesh.position.set(5, y - 10, -577.3);
        mesh.scale.set(4, 1, 4.5);
        // mesh.rotation.set(0, Math.PI/2, 0);
        scene.add(mesh);
      },
  ...
  drawRoads(loader, y, scene) {
    ...
    loader.load(
      ...
      function (gltf) {
        let mesh = gltf.scene;
        mesh.position.set(5, y - 10, -361.8);
        mesh.scale.set(15, 1, 2);
        mesh.rotation.set(0, Math.PI / 2, 0);
        scene.add(mesh);
      },
    ...
    loader.load(
      ...
      function (gltf) {
        let mesh = gltf.scene;
        mesh.position.set(194.1, y - 10, 181.9);
        // mesh.rotation.set(0, Math.PI/2, 0);
    ...
    loader.load(
      ...
      function (gltf) {
        let mesh = gltf.scene;
        mesh.position.set(894.7, y - 10, 181.9);
        // mesh.rotation.set(0, Math.PI/2, 0);
        mesh.scale.set(24.8, 1, 2);
    ...
    loader.load(
      ...
      function (gltf) {
        let mesh = gltf.scene;
        mesh.position.set(544.4, y - 10, 181.9);
        // mesh.rotation.set(0, Math.PI/2, 0);
        mesh.scale.set(24.8, 1, 2);
    ...
    loader.load(
      ...
      function (gltf) {
        let mesh = gltf.scene;
        mesh.position.set(1084, y - 10, 97.1);
    ...
    loader.load(
      ...
      function (gltf) {
        let mesh = gltf.scene;
        mesh.position.set(1084, y - 10, -44.1);
        mesh.scale.set(10, 1, 2);
        mesh.rotation.set(0, Math.PI / 2, 0);
        scene.add(mesh);
      },
    ...
    loader.load(
      ...
      function (gltf) {
        let mesh = gltf.scene;
        mesh.position.set(894.9, y - 10, -128.9);
        // mesh.rotation.set(0, Math.PI/2, 0);
        mesh.scale.set(24.8, 1, 2);
    ...
    loader.load(
      ...
      function (gltf) {
        let mesh = gltf.scene;
        mesh.position.set(544.6, y - 10, -128.9);
        // mesh.rotation.set(0, Math.PI/2, 0);
        mesh.scale.set(24.8, 1, 2);
    ...
    loader.load(
      ...
      function (gltf) {
        let mesh = gltf.scene;
        mesh.position.set(355.3, y - 10, -248.9);
        mesh.scale.set(15, 1, 2);
        mesh.rotation.set(0, Math.PI / 2, 0);
        scene.add(mesh);
      },
    ...
    loader.load(
      ...
      function (gltf) {
        let mesh = gltf.scene;
        mesh.position.set(544.6, y - 10, -368.9);
        // mesh.rotation.set(0, Math.PI/2, 0);
        mesh.scale.set(24.8, 1, 2);
    ...
    loader.load(
      ...
      function (gltf) {
        let mesh = gltf.scene;
        mesh.position.set(733.9, y - 10, -488.9);
        mesh.scale.set(15, 1, 2);
        mesh.rotation.set(0, Math.PI / 2, 0);
        scene.add(mesh);
      },
    ...
    loader.load(
      ...
      function (gltf) {
        let mesh = gltf.scene;
        mesh.position.set(544.6, y - 10, -608.9);
        // mesh.rotation.set(0, Math.PI/2, 0);
        mesh.scale.set(24.8, 1, 2);
    ...
    loader.load(
      ...
      function (gltf) {
        let mesh = gltf.scene;
        mesh.position.set(194.3, y - 10, -608.9);
        // mesh.rotation.set(0, Math.PI/2, 0);
        mesh.scale.set(24.8, 1, 2);
    ...
    loader.load(
      ...
      function (gltf) {
        let mesh = gltf.scene;
        mesh.position.set(5, y - 10, -531.1);
        mesh.scale.set(9, 1, 2);
        mesh.rotation.set(0, Math.PI / 2, 0);
        scene.add(mesh);
      },
      // called while loading is progressing
  ...
  skybox() {
    ...
    const sky = loader.load([
      "./resources/valley_ft.jpg",
      "./resources/valley_bk.jpg",
      "./resources/valley_up.jpg",
      "./resources/valley_dn.jpg",
      "./resources/valley_rt.jpg",
      "./resources/valley_lf.jpg",
    ]);
  ...
  ground() {
    ...
    const grass = new THREE.MeshBasicMaterial({
      map: textureLoader.load("./resources/grass2.jpg", function (texture) {
  ...
  initPhysics() {
    ...
    const contact_ground_sphere = new CANNON.ContactMaterial(
      this.groundMaterial,
      this.sphereMaterial,
...
class BasicCharacterController {
  ...
  Update(timeInSeconds) {
    ...
    if (
      this._target.position.x <= 55 &&
      this._target.position.x >= -50 &&
      this._target.position.z < -56 &&
      this._target.position.z > -58
    ) {
      hasWon = true;
    }
  }
...
class CannonHelper {
  ...
  addVisual(body, name, castShadow = true, receiveShadow = true) {
    ...
    if (this.currentMaterial === undefined)
      this.currentMaterial = new THREE.MeshLambertMaterial({ color: 0x088888 });
